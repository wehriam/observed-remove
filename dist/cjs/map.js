 ...
 */
class ObservedRemoveMap extends _events.default {
  ...
  set(key, value, id = (0, _generateId.default)()) {
    const pair = this.pairs.get(key);
  ...
  *values() {
    for (const [id, value] of this.pairs.values()) {
      // eslint-disable-line no-unused-vars
      yield value;
    }
  }
...
exports.default = ObservedRemoveMap;
